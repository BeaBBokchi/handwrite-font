...
const StandardKorean = () => {
    ...
    const handleUploadBtn = async () => {
        ...
        // Storage Instance
        const { storage, ref, uploadString, getDownloadURL } = fireStorage;
        // upload
